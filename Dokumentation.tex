...
\DescribeMacro{\memoevent}\meta{Shape}\meta{Name}\meta{x-Pos.}\meta{y-Pos.}\meta{ID}\meta{Bezeichnung}\medskip

Makro für Ereignisse.\bigskip

\DescribeMacro{\memoeventloaded}\meta{Shape}\meta{Name}\meta{x-Pos.}\meta{y-Pos.}\medskip
...
\DescribeMacro{\memoconn}\meta{Name linker Knoten}\meta{Name rechter Knoten}\medskip

 Makro für gerade Kanten.\bigskip

\DescribeMacro{\memoparaconn}\meta{Name Ereignis}\meta{Name Prozess}\meta{Anker}\medskip
