...
\definecolor{memodarkgrey}{RGB}{196,197,198}
\definecolor{memolightgreen}{RGB}{208,222,156}
\definecolor{memolightorange}{RGB}{235,107,74}
...
\pgfdeclareshape{modifiedevent}{
    ...
    \beforeforegroundpath{
        ...
        \begin{pgfscope}
            ...
            \pgfpathquadraticcurveto{\pgfpoint{18}{19}}{\pgfpoint{15.8}{14}} 
...
%~~ Basisshape für zeitliches Ereignis
...
%~~ Zeitliches Ereignis - Zeitpunkt erreicht
...
%~~ Zeitliches Ereignis - Zeitdauer erreicht
...
%~~ Basisshape für Softwarebenachrichtigung
...
%~~ Softwarebenachrichtigung - Poll
\pgfdeclareshape{pollsoftwareevent}{
    %~~ Üernahme der Anchor aus dem standard Rechteck
    %~~ Shape
    \inheritsavedanchors[from=rectangle]            
    \inheritanchorborder[from=rectangle] 
    \inheritanchor[from=rectangle]{center} 
...
%~~ Softwarebenachrichtigung - Publish
...
%~~ Manuelle Entscheidung mit eindeutigen Regeln
...
%~~ ######################################
%~~ Verbindungsstück Dekompositionsdiagramm
%~~ ######################################
\pgfdeclareshape{decompositionplus}{
    ...
    \backgroundpath{
        ...
        \end{pgfscope}
           ...
           \begin{pgfscope}
            \pgfsetcolor{blue}        
            \pgfsetlinewidth{2pt}
            \pgfpathmoveto{\pgfpoint{0}{19}}
           \pgfpathlineto{\pgfpoint{0}{22}}            
            \pgfusepath{stroke,fill} 
        \end{pgfscope}
         ...
         \begin{pgfscope}
            \pgfsetcolor{blue}        
            \pgfsetlinewidth{2pt}            
            \pgfpathmoveto{\pgfpoint{19}{0}}
           \pgfpathlineto{\pgfpoint{22}{0}}
            \pgfusepath{stroke,fill} 
        \end{pgfscope}
