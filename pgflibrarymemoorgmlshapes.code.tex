...
\pgfdeclareshape{exception}{
	...
	\backgroundpath{
    	...
    	\begin{pgfscope}
            ...
            \pgfpathmoveto{\pgfpoint{0}{2.02}}
        	\pgfpathlineto{\pgfpoint{0}{-4}}
        	\pgfpathlineto{\pgfpoint{8}{-4}}
        	\pgfpathlineto{\pgfpoint{8}{2.02}}
        	\pgfpathlineto{\pgfpoint{0}{2.02}} 
        	\pgfusepath{fill}
    	\end{pgfscope}
    	...
    	\begin{pgfscope}
        	...
        	%~~ Erzeugen des Verbindungsstückes für die
        	%~~ parallele Ausführung von Prozessen  
        	\pgfpathmoveto{\pgfpoint{0}{2}}
        	\pgfpathcurveto{\pgfpoint{2}{6}}{\pgfpoint{6}{6}}{\pgfpoint{8}{2}}
        	
        	
        	\pgfpathmoveto{\pgfpoint{0}{1.75}}
        	\pgfpathlineto{\pgfpoint{0}{-4}} 
        	
        	\pgfpathmoveto{\pgfpoint{8}{1.75}}
        	\pgfpathlineto{\pgfpoint{8}{-4}}		
    	...
    	\begin{pgfscope}
            ...
            \pgfpathrectanglecorners{\pgfpoint{-0.85}{-4}}{\pgfpoint{8.95}{-7.5}}       
    	   \pgfusepath{stroke, fill}
    	\end{pgfscope}
    	...
    	\begin{pgfscope}
    	    ...
    	    \pgfsetfillcolor{white}
    	    \pgfsetstrokecolor{white}
    	    \pgfpathmoveto{\pgfpoint{4}{3.8}}
    	    \pgfpathquadraticcurveto{\pgfpoint{7.2}{3.5}}{\pgfpoint{6.7}{-3}}
    	    \pgfpathmoveto{\pgfpoint{4}{3.8}}
    	    \pgfpathquadraticcurveto{\pgfpoint{7}{3.5}}{\pgfpoint{6.4}{-3}}
    	    \pgfpathmoveto{\pgfpoint{4}{3.8}}
    	    \pgfpathquadraticcurveto{\pgfpoint{6.8}{3.5}}{\pgfpoint{6.2}{-3}}
    	    \pgfpathmoveto{\pgfpoint{4}{3.8}}
    	    \pgfpathquadraticcurveto{\pgfpoint{6.6}{3.5}}{\pgfpoint{6}{-3}}
    	    \pgfpathmoveto{\pgfpoint{6}{-3}}
    	    \pgfpathlineto{\pgfpoint{6.7}{-3}}
    	    \pgfusepath{stroke}
    	\end{pgfscope}
