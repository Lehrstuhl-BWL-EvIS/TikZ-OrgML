%~~ ToDo Umwandeln in ein Minimalbeispiel
...
%~~ ToDo Auslagerung in eines *.sty-File
...
Test eines Dekompositionsdiagrammes mittels eines Tree:\bigskip

\begin{tikzpicture}
    \node[shape=decompprocess, decompprocess, anchor=center] {}
        [edge from parent fork down]
            child{ node[shape=decompprocess, decompprocess] at (-2,0) {}}
            child{ node[shape=decompprocess, decompprocess] at (0,0) {}}
            child{ node[shape=decompprocess, decompprocess] at (2,0) {}};
\end{tikzpicture}\bigskip\bigskip

Test eines Kontrollflussdiagramms mittels eine Tree:\bigskip\bigskip
