...
\pgfdeclareshape{startevent}{
	...
	\backgroundpath{
    	...
    	\pgftext[right, x=\pgf@xc*1.5, y=\pgf@yb*1.25]{\textsf{\fontsize{2}{6}\selectfont START}}
    }
}
...
%~~ TikZ-Bild
\begin{tikzpicture}
    \node[draw, inner sep=3.5ex, shape=startevent] (x) at (0,0) {};
    \node[draw, inner sep=2.5ex, text width=6em, shape=unspecprocess] (y) at (6,0) {};
    \node[draw, inner sep=3.5ex, shape=startevent] (z) at (10,0) {};
