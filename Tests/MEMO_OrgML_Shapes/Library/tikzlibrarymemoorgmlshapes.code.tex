...
\pgfdeclareshape{iterationstart}{
    ...
    \backgroundpath{
        ...
        \pgfpathmoveto{\pgfpoint{\pgf@xa}{\pgf@yb*0.5}}   
        \pgfpathlineto{\pgfpoint{\pgf@xa}{\pgf@ya*0.5}}
        \pgfpathlineto{\pgfpoint{\pgf@xb}{\pgf@ya*0.5}}
        \pgfpathlineto{\pgfpoint{\pgf@xb}{\pgf@yb*0.5}}
        \pgfpathlineto{\pgfpoint{\pgf@xa}{\pgf@yb*0.5}}        
    ...
    \beforebackgroundpath{
        ...
        \pgfpathmoveto{\pgfpoint{\pgf@xa*0.4}{\pgf@yb*0.35}}
        \pgfpathlineto{\pgfpoint{\pgf@xb*0.6}{\pgf@ya*0}}
        \pgfpathlineto{\pgfpoint{\pgf@xa*0.4}{\pgf@ya*0.35}}
        \pgfpathlineto{\pgfpoint{\pgf@xa*0.4}{\pgf@yb*0.35}}
